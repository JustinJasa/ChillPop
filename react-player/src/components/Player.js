  ...
  return(
    <div className="player">
      ...
      <div className="play-control">
        ...
        {/* <FontAwesomeIcon onClick = {shuffleHanlder} className = "shuffle"  size = "2x" icon = {faRandom}/> */}
        <FontAwesomeIcon onClick = {playSongHandler} className = "play" size = "2x" icon = {isPlaying ? faPause:faPlay}/>
        {/* <FontAwesomeIcon onClick = {repeatHandler} className = "repeat"  size = "2x" icon = {faRedo}/> */}
